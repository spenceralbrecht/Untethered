...
FIREBASE_PROJECT="${OLAUNCHER_FIREBASE_PROJECT:-${FIREBASE_PROJECT:-olauncher-focus-sspen}}"
FIREBASE_APP_ID="${OLAUNCHER_FIREBASE_APP_ID:-${FIREBASE_APP_ID:-1:1702988366:android:371720708d5907240dd11f}}"
