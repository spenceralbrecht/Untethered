...
import app.untethered.helper.SingleLiveEvent
import app.untethered.helper.WallpaperWorker
import app.untethered.helper.formattedTimeSpent
import app.untethered.helper.getAppsList
import app.untethered.helper.getPrivateSpaceApps
import app.untethered.helper.getPrivateSpaceUserHandle
...
import app.untethered.helper.isPrivateSpaceLocked
import app.untethered.helper.showToast
import app.untethered.helper.usageStats.EventLogWrapper
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val isUntetheredDefault = MutableLiveData<Boolean>()
    ...
    fun isUntetheredDefault() {
        isUntetheredDefault.value = isUntetheredDefault(appContext)
    }
