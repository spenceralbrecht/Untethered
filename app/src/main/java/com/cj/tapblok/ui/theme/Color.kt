...
val DarkSecondaryContainer = Color(0xFF101010)
val DarkOnSecondaryContainer = Color(0xFFE8E8E8)
val DarkBackground = Color(0xFF000000)
val DarkOnBackground = Color(0xFFF5F5F5)
val DarkSurface = Color(0xFF000000)
val DarkOnSurface = Color(0xFFF5F5F5)
val DarkSurfaceVariant = Color(0xFF090909)
val DarkOnSurfaceVariant = Color(0xFF9A9A9A)
val DarkOutline = Color(0xFF4A4A4A)
val DarkOutlineVariant = Color(0xFF171717)
